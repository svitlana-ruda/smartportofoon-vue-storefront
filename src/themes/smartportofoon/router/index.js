...
const Smartportofoon = () => import(/* webpackChunkName: "vsf-smartportofoon" */ 'theme/pages/Smartportofoon.vue')
...
let routes = [
  ...
  {
    name: 'over-portofoonweb',
    path: '/over-portofoonweb',
    component: Static,
    props: { page: 'lorem', title: 'Over PortofoonWEB' }
  },
  {
    name: 'offerte-aanvraag',
    path: '/offerte-aanvraag',
    component: Static,
    props: { page: 'lorem', title: 'Offerte aanvraag' }
  },
  {
    name: 'defect-en-retour',
    path: '/defect-en-retour',
    component: Static,
    props: { page: 'lorem', title: 'Defect en Retour' }
  },
  { name: 'garantie', path: '/garantie', component: Static, props: { page: 'lorem', title: 'Garantie' } },
  {
    name: 'veelgestelde-vragen',
    path: '/veelgestelde-vragen',
    component: Static,
    props: { page: 'lorem', title: 'Veelgestelde vragen' }
  },
  { name: 'b2b', path: '/b2b', component: Static, props: { page: 'lorem', title: 'B2B' } },
  { name: 'portofoons', path: '/portofoons', component: Static, props: { page: 'lorem', title: 'Portofoons' } },
  { name: 'toepassingen', path: '/toepassingen', component: Static, props: { page: 'lorem', title: 'Toepassingen' } },
  {
    name: 'algemene-voorwaarden',
    path: '/algemene-voorwaarden',
    component: Static,
    props: { page: 'lorem', title: 'Algemene voorwaarden' }
  },
  {
    name: 'betalen-en-verzenden',
    path: '/betalen-en-verzenden',
    component: Static,
    props: { page: 'lorem', title: 'Betalen en Verzenden' }
  },
  { name: 'disclaimer', path: '/disclaimer', component: Static, props: { page: 'lorem', title: 'Disclaimer' } },
  { name: 'nieuws', path: '/nieuws', component: Static, props: { page: 'lorem', title: 'Nieuws' } },
  {
    name: 'smartportofoon',
    path: '/smartportofoon',
    component: Smartportofoon,
    props: { page: 'lorem', title: 'Smartportofoon' }
  }
]
