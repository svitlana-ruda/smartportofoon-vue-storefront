<template>
  ...
  <div slot="content">
    <form @submit.prevent="subscribe(onSuccesfulSubmission)" novalidate>
      ...
      <button class="btn__submit" type="submit" :disabled="this.$v.$invalid">
        <span class="awesome__mail">
          <i class="fas fa-paper-plane" />
        </span>
      </button>
      <!-- <button-full class="mb35" type="submit" :disabled="this.$v.$invalid" @click.native="$v.email.$touch">
        {{ $t('Subscribe') }}
      </button-full> -->
    </form>
  </div>
